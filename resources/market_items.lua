...
return {
    ...
    {price = {{market_item, 5}}, offer = {type = 'give-item', item = 'rail', count = 4}},
    {price = {{market_item, 5}}, offer = {type = 'give-item', item = 'rail-signal', count = 2}},
    {price = {{market_item, 5}}, offer = {type = 'give-item', item = 'rail-chain-signal', count = 2}},
    {price = {{market_item, 10}}, offer = {type = 'give-item', item = 'train-stop'}},
    {price = {{market_item, 94}}, offer = {type = 'give-item', item = 'locomotive'}},
    {price = {{market_item, 35}}, offer = {type = 'give-item', item = 'cargo-wagon'}},
    {price = {{market_item, 1}}, offer = {type = 'give-item', item = 'red-wire', count = 1}},
    {price = {{market_item, 1}}, offer = {type = 'give-item', item = 'green-wire', count = 1}},
    {price = {{market_item, 4}}, offer = {type = 'give-item', item = 'decider-combinator'}},
    {price = {{market_item, 4}}, offer = {type = 'give-item', item = 'arithmetic-combinator'}},
    {price = {{market_item, 2}}, offer = {type = 'give-item', item = 'constant-combinator'}},
    {price = {{market_item, 4}}, offer = {type = 'give-item', item = 'programmable-speaker'}},
	{price = {{market_item, 2}}, offer = {type = 'give-item', item = 'small-lamp'}},
    {price = {{market_item, 3}}, offer = {type = 'give-item', item = 'piercing-rounds-magazine'}},
    {price = {{market_item, 3}}, offer = {type = 'give-item', item = 'grenade'}},
    {price = {{market_item, 2}}, offer = {type = 'give-item', item = 'land-mine'}},
    {price = {{market_item, 2}}, offer = {type = 'give-item', item = 'solid-fuel'}},
	
    --{price = {{market_item, 8}}, offer = {type = 'give-item', item = 'steel-axe'}},
    --{price = {{market_item, 15}}, offer = {type = 'give-item', item = 'rocket-launcher'}},
    --{price = {{market_item, 4}}, offer = {type = 'give-item', item = 'rocket'}},
    --{price = {{market_item, 8}}, offer = {type = 'give-item', item = 'explosive-rocket'}},   
    {price = {{market_item, 175}}, offer = {type = 'give-item', item = 'railgun'}},
    {price = {{market_item, 35}}, offer = {type = 'give-item', item = 'railgun-dart', count = 10}},
    {price = {{market_item, 175}}, offer = {type = 'give-item', item = 'loader'}},
    {price = {{market_item, 350}}, offer = {type = 'give-item', item = 'fast-loader'}},
    {price = {{market_item, 700}}, offer = {type = 'give-item', item = 'express-loader'}},
    {price = {{market_item, 500}}, offer = {type = 'give-item', item = 'belt-immunity-equipment'}},
    --{price = {{market_item, 42}}, offer = {type = 'give-item', item = 'night-vision-equipment'}},
   -- {price = {{market_item, 240}}, offer = {type = 'give-item', item = 'modular-armor'}},
	--{price = {{market_item, 1463}}, offer = {type = 'give-item', item = 'power-armor'}},
	--{price = {{market_item, 21337}}, offer = {type = 'give-item', item = 'power-armor-mk2'}},
   -- {price = {{market_item, 472}}, offer = {type = 'give-item', item = 'personal-roboport-equipment'}},
   -- {price = {{market_item, 22}}, offer = {type = 'give-item', item = 'construction-robot', count = 1}},
    --{price = {{market_item, 95}}, offer = {type = 'give-item', item = 'solar-panel-equipment', count = 1}},
    --{price = {{market_item, 37}}, offer = {type = 'give-item', item = 'battery-equipment', count = 1}},
    --{price = {{market_item, 987}}, offer = {type = 'give-item', item = 'battery-mk2-equipment', count = 1}},
	--{price = {{market_item, 38}}, offer = {type = 'give-item', item = 'energy-shield-equipment'}},
    --{price = {{market_item, 6753}}, offer = {type = 'give-item', item = 'fusion-reactor-equipment', count = 1}},
    --{price = {{market_item, 474}}, offer = {type = 'give-item', item = 'exoskeleton-equipment'}},	
	{price = {{market_item, 5}}, offer = {type = 'give-item', item = 'raw-wood', count = 25}},
	{price = {{market_item, 5}}, offer = {type = 'give-item', item = 'iron-ore', count = 25}},
    {price = {{market_item, 5}}, offer = {type = 'give-item', item = 'copper-ore', count = 25}},
    {price = {{market_item, 5}}, offer = {type = 'give-item', item = 'stone', count = 25}},
	{price = {{market_item, 5}}, offer = {type = 'give-item', item = 'coal', count = 25}},	
	{price = {{market_item, 5}}, offer = {type = 'give-item', item = 'uranium-ore', count = 20}},
	{price = {{'raw-wood', 25}}, offer = {type = 'give-item', item = market_item, count = 2}},	
	{price = {{'iron-ore', 25}}, offer = {type = 'give-item', item = market_item, count = 2}},
    {price = {{'copper-ore', 25}}, offer = {type = 'give-item', item = market_item, count = 2}},
    {price = {{'stone', 25}}, offer = {type = 'give-item', item = market_item, count = 2}},
	{price = {{'coal', 25}}, offer = {type = 'give-item', item = market_item, count = 2}},	
	{price = {{'uranium-ore', 20}}, offer = {type = 'give-item', item = market_item, count = 2}}		
}
