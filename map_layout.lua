...
--table.insert(miscs, require("locale.gen_misc.wreck_items"))
--table.insert(miscs, require("locale.gen_misc.tris_chunk_grid"))
--table.insert(miscs, require("locale.gen_ores.glitter_ores"))
