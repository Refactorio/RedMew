...
local loot = {
    ...
    {stack = {name = 'effectivity-module', count = 15, distance_factor = 1 / 10}, weight = 5},
    {stack = {name = 'speed-module', count = 10, distance_factor = 1 / 10}, weight = 5},
    {stack = {name = 'productivity-module', count = 10, distance_factor = 1 / 10}, weight = 5}
}
