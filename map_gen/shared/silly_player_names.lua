...
ScenarioInfo.add_map_extra_info('- On this map you will be assigned a new name, which resets when leaving the world.\n' .. '- If you dislike your name you can /name-roll for a new one')
