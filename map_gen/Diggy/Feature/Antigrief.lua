...
Event.add(
    CaveCollapse.events.on_collapse,
    function(event)
        ...
        if player_index and global.Antigrief.last_collapse ~= game.tick then
            ...
            if
                global.Antigrief.autojail and count > allowed_collapses_first_hour and player.online_time < 216000 and
                    not global.Antigrief.jailed_players[player_index]
             then
                Report.jail(player)
