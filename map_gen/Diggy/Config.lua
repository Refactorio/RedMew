            ...
            unlockables = require('map_gen.Diggy.FormatMarketItems').initialize_unlockables(
                {
                    ...
                    {level = 2, price = 50, name = 'steel-axe'},
                    {level = 3, price = 20, name = 'raw-fish'},
                    {level = 3, price = 50, name = 'stone-brick'},
                    {level = 5, price = 25, name = 'small-lamp'},
                    {level = 5, price = 125, name = 'stone-wall'},
                    {level = 5, price = 50, name = 'firearm-magazine'},
                    {level = 6, price = 850, name = 'shotgun'},
                    {level = 6, price = 50, name = 'shotgun-shell'},
                    {level = 8, price = 850, name = 'submachine-gun'},
                    {level = 9, price = 500, name = 'light-armor'},
                    {level = 13, price = 750, name = 'heavy-armor'},
                    {level = 14, price = 100, name = 'piercing-rounds-magazine'},
                    {level = 14, price = 100, name = 'piercing-shotgun-shell'},
                    {level = 16, price = 1500, name = 'modular-armor'},
                    {level = 16, price = 1000, name = 'landfill'},
                    {level = 18, price = {{"stone", 900}, {"coin", 25}}, name = 'personal-roboport-equipment'},
                    {level = 18, price = {{"stone", 250}, {"coin", 10}}, name = 'construction-robot'},
                    {level = 20, price = {{"stone", 2500}, {"coin", 100}}, name = 'power-armor'},
                    {level = 21, price = {{"stone", 150}, {"coin", 10}}, name = 'battery-equipment'},
                    {level = 21, price = {{"stone", 2000}, {"coin", 75}}, name = 'fusion-reactor-equipment'},
                    {level = 23, price = {{"stone", 750}, {"coin", 20}}, name = 'energy-shield-equipment'},
