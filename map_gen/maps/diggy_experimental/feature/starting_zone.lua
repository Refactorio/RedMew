...
local Template = require 'map_gen.maps.diggy_experimental.template'
local Retailer = require 'features.retailer'
local DiggyCaveCollapse = require 'map_gen.maps.diggy_experimental.feature.diggy_cave_collapse'
            ...
            for y = -starting_zone_size, starting_zone_size do
                ...
                if (distance < starting_zone_size) then
                    ...
                    if (distance > rock_range) then
                        insert(rocks, {name = config.start_entity, position = {x = x, y = y}})
                    end
