...
local Config = {
    ...
    features = {
        ...
        setup_player = {
            ...
            initial_mining_speed_bonus = 0.25,
        ...
        coin_gathering = {
            ...
            treasure_chest_raffle = {
                ...
                ['stone'] = {chance = 0.80, min = 3, max = 40},
        ...
        scattered_resources = {
            ...
            ore_pattern = require 'map_gen.maps.black_forest.orepattern.tendrils_impure'

            -- spawns some smaller dedicated and bigger mixed tendrils
            --ore_pattern = require 'map_gen.maps.black_forest.orepattern.tendrils',

            -- spawns clusters of ore similar to vanilla, but mixed
            --ore_pattern = require 'map_gen.maps.black_forest.orepattern.clusters',
        },
        ...
        antigrief = {
            enabled = false,
            autojail = true,
            allowed_collapses_first_hour = 40
        },
        experience = {
            enabled = true,
            -- controls the formula for calculating level up costs in stone sent to surface
            difficulty_scale = 20, -- black_forest default 15. Higher increases experience requirement climb
            first_lvl_xp = 350, -- black_forest default 350. This sets the price for the first level.
            xp_fine_tune = 400, -- black_forest default 200. This value is used to fine tune the overall requirement climb without affecting the speed
            cost_precision = 3, -- black_forest default 3. This sets the precision of the required experience to level up. E.g. 1234 becomes 1200 with precision 2 and 1230 with precision 3.
            ...
            XP = {
                ...
                ['rock-big'] = 5,
                ['rock-huge'] = 10,
                ['rocket_launch'] = 0.05, -- XP reward in percentage of total experience when a rocket launches (black_forest default: 0.05 which equals 5%)
                ['rocket_launch_max'] = 500000, -- Max XP reward from rocket launches (black_forest default: 500000)
                ...
                ['death-penalty'] = 0.0035, -- XP deduct in percentage of total experience when a player dies (black_forest default: 0.0035 which equals 0.35%)
                --['cave-in-penalty']         = 100        -- XP lost every cave in.
                ['infinity-research'] = 0.60 -- XP reward in percentage of the required experience from current level to next level (black_forest default: 0.60 which equals 60%)
            },
            buffs = {
                -- define new buffs here, they are handed out for each level
                mining_speed = {value = 5, max = 10},
                inventory_slot = {value = 1, max = 100},
                -- double_level is the level interval for receiving a double bonus (black_forest default: 5 which equals every 5th level)
            ...
            unlockables = {
                {level = 1, price = 1, name = 'stone-brick'},
