...
return ob.make_walls{
    ob.make_4_way {
        ...
        [13] = {entity = {name = 'gun-turret', offset = 3, callback = 'turret'}, tile = 'refined-hazard-concrete-left'},
        [14] = {tile = 'refined-hazard-concrete-left'},
        [15] = {entity = {name = 'gun-turret', offset = 3, callback = 'turret'}, tile = 'refined-hazard-concrete-left'},
        [16] = {tile = 'refined-hazard-concrete-left'},
        [17] = {entity = {name = 'gun-turret', offset = 3, callback = 'turret'}, tile = 'refined-hazard-concrete-left'},
        ...
        [25] = {entity = {name = 'gun-turret', offset = 3, callback = 'turret'}, tile = 'refined-hazard-concrete-left'},
        [26] = {tile = 'refined-hazard-concrete-left'},
        [27] = {entity = {name = 'gun-turret', offset = 3, callback = 'turret'}, tile = 'refined-hazard-concrete-left'},
        [28] = {tile = 'refined-hazard-concrete-left'},
        [29] = {entity = {name = 'gun-turret', offset = 3, callback = 'turret'}, tile = 'refined-hazard-concrete-left'},
    ...
    ob.make_4_way {
        ...
        [1] = {entity = {name = 'stone-wall'}},
        [2] = {entity = {name = 'stone-wall'}},
        [3] = {entity = {name = 'gun-turret', offset = 3, callback = 'turret'}, tile = 'refined-hazard-concrete-left'},
        [4] = {tile = 'refined-hazard-concrete-left'},
        [5] = {entity = {name = 'gun-turret', offset = 3, callback = 'turret'}, tile = 'refined-hazard-concrete-left'},
