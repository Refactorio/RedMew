...
ScenarioInfo.set_map_name('Danger Ore Square Deadlock Beltboxes (ore only)')
...
restart_command({
    scenario_name = 'danger-ore-square-beltboxes-ore-only'
})
...
local main_ores_builder = require 'map_gen.maps.danger_ores.modules.main_ores_square'
...
local config = {
    ...
    start_ore_shape = b.translate(b.rectangle(88), -start_ore_offset, start_ore_offset),
    post_map_func = post_map_func,
    no_resource_patch_shape = b.rectangle(160),
    no_water_shape = b.circle(192),
    main_ores_builder = main_ores_builder,
    main_ores = main_ores_config,
    main_ores_shuffle_order = true,
    main_ores_start_ore_offset = start_ore_offset,
    -- main_ores_rotate = 45,
