...
ScenarioInfo.set_map_name('Danger Ore 3way Beltboxes (ore only)')
...
local t_h_bound = b.line_x(128)
local t_v_bound = b.line_y(128)
...
restart_command({scenario_name = 'danger-ore-3way-beltboxes-ore-only'})
