...
ScenarioInfo.set_map_name('Danger Ore For The Swarm Beltboxes (ore only)')
...
Config.player_create.starting_items = {
    ...
    {name = 'personal-roboport-equipment', count = 9},
    {name = 'solar-panel-equipment', count = 13},
    {name = 'early-construction-robot', count = 1000},
    {name = 'spidertron', count = 1},
    {name = 'spidertron-powersource', count = 1},
    {name = 'spidertron-battery', count = 10},
    {name = 'spidertron-leg-augment', count = 3}
}
...
restart_command({scenario_name = 'danger-ore-for-the-swarm-beltboxes-ore-only'})
...
local main_ores_builder = require 'map_gen.maps.danger_ores.modules.main_ores_honeycomb'
