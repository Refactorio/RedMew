...
ScenarioInfo.set_map_name('Danger Ore Patches')
...
local main_ore_resource_patches_config = require 'map_gen.maps.danger_ores.config.main_ore_resource_patches'
...
restart_command({scenario_name = 'danger-ore-patches'})
