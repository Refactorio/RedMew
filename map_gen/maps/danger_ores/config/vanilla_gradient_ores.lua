...
return {
    ['iron-ore'] = {
        ...
        start = value(40, 0),
        shape = b.resource(b.full_shape, 'iron-ore', value(1, 1)),
        weight = function(v)
            return 4 * (v ^ 4) + 0.25
        end
    },
    ['copper-ore'] = {
        ...
        start = value(40, 0),
        shape = b.resource(b.full_shape, 'copper-ore', value(1, 1)),
        weight = function(v)
            return 3 * (v ^ 4) + 0.2
        end
    },
    ['coal'] = {
        ...
        start = value(40, 0),
        shape = b.resource(b.full_shape, 'coal', value(1, 1)),
        weight = function(v)
            return 2.5 * (v ^ 6) + 0.2
        end
    },
    ['stone'] = {
        ...
        start = value(40, 0),
        shape = b.resource(b.full_shape, 'stone', value(1, 1)),
        weight = function(v)
            return 1 * (v ^ 6) + 0.15
        end
    }
