...
---Use "/pinguin-reset" to reset all features's levels (admin/server only)
Command.add(
    'pinguin-reset',
    {
...
---Use "/pinguin-debug" to print all feature's levels, only to admin (admin/server only)
Command.add(
    'pinguin-debug',
    {
...
---Use "/pinguin-max" to set all features to their max level (admin/server only)
Command.add(
    'pinguin-max',
    {
