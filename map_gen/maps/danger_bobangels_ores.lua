...
local ores_init = require 'map_gen.maps.danger_bobangels_ores.ore'
local RocketLaunched = require 'map_gen.maps.danger_bobangels_ores.rocket_launched'
