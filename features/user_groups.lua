...
Module.is_regular =
    ...
    return Utils.cast_bool(global.regulars[player_name] or global.regulars[player_name:lower()]) or global.Donators[player_name] --to make it backwards compatible
end
