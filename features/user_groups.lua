...
Module.is_regular =
    ...
    return Utils.cast_bool(global.regulars[player_name] or (global.silly_regulars and global.silly_regulars[player_name])) -- silly_names hack since we change player.name
end
