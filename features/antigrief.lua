...
Event.add(
    ...
    function(event)
        ...
        if
            event.entity and event.entity.valid and event.entity.force.name == 'player' and event.cause and
                event.cause.force == event.entity.force and
                event.cause.type == 'player'
         then
