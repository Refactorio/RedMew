...
commands.add_command(
    'tpspawn',
    '<player> <spawn_name> teleports a player to the spawn point (Admins only)',
    tp_spawn_command
)
commands.add_command(
    'changespawn',
    '<player> <spawn_name> changes the spawn point for a player (Admins only)',
    change_spawn_command
)
commands.add_command('printspawns', 'prints info on all spawn points (Admins only)', print_spawns_command)
commands.add_command(
    'printplayersforspawn',
    '<spawn_name> prints all the connected players for a spawn (Admins only)',
    print_players_for_spawn_command
)
